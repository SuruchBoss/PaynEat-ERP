...
| [0019](docs/adr/0019-exact-quantities-and-conversion-rounding.th.md) | *เสนอ* ปริมาณและตัวคูณเป็นทศนิยมแบบแม่นยำ ไม่ใช่ floating point; ตัวคูณต้องมากกว่าศูนย์เสมอ; การแปลงเป็นหน่วยหลักปัดเศษครั้งเดียวแบบครึ่งหนึ่งปัดออกจากศูนย์ตามทศนิยมของหน่วยนั้น; หน่วยหลักของสินค้าเปลี่ยนไม่ได้ |
