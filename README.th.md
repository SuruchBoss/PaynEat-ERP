...
**[เปิดเดโมสาธารณะ](https://suruchboss.github.io/PaynEat-ERP/)**: console ตัวจริงบนข้อมูลของเชนสมมติ ทำงานในเบราว์เซอร์ทั้งหมด
ไม่มีเซิร์ฟเวอร์และไม่เก็บอะไรไว้ ส่วนการติดตั้งจริงยังใช้ `docker compose` เหมือนเดิม

**[ดูว่าแก้ปัญหาอะไรได้บ้าง](https://suruchboss.github.io/PaynEat-ERP/about/index.th.html)**: หน้าแนะนำผลิตภัณฑ์ เล่าทีละปัญหา
พร้อมหน้าจอจากเดโม
...
> การตรวจสอบ และข้อมูลหลัก: สินค้า หน่วยนับ หน่วยซื้อพร้อมตัวคูณแปลงหน่วยแบบแม่นยำ สถานที่เก็บสต๊อก (โรงงาน คลัง
> และสาขา โดยโรงงานและคลังแต่ละแห่งมีสถานที่ระหว่างขนส่งของตัวเอง) ซัพพลายเออร์ และบันทึกการเปลี่ยนแปลง
> master data แบบมีเวอร์ชันที่ POS จะดึงไปใช้ รวมถึง **stock ledger**: lot, รายการเคลื่อนไหวที่แก้หรือลบไม่ได้,
> ยอดยกมาที่ post ในธุรกรรมเดียวและแก้ได้ด้วยการกลับรายการเท่านั้น และสต๊อกคงเหลือ ณ วันใดก็ได้พร้อมมูลค่า
> console ใช้ได้ทั้งคอมพิวเตอร์ แท็บเล็ต (เมนูย่อเหลือไอคอน) และมือถือ (ตารางเปลี่ยนเป็นการ์ดแถวละใบ) ทั้งโหมดสว่างและมืด
และใครก็ลองได้ในเบราว์เซอร์ที่[เดโมสาธารณะ](https://suruchboss.github.io/PaynEat-ERP/)
> ยังไม่มีเอกสารจัดซื้อ ผลิต หรือโอน กำลังสร้างแบบเปิดเผยทีละ issue บน GitHub README นี้บอกเฉพาะสิ่งที่จริง
> ณ วันนี้ และจะเพิ่มขึ้นเมื่อแต่ละส่วนใช้งานได้จริง

<!-- problems:start -->
<!-- Generated by docs/landing/build.mjs from docs/landing/content.mjs (#45). Edit those, not this section. -->

## ปัญหาที่แก้ได้แล้ววันนี้
...
<p align="center">
  <img src="docs/landing/img/th-stock.webp" width="720" alt="สต๊อกคงเหลือตามสินค้า lot และสถานที่ พร้อมต้นทุนต่อหน่วย มูลค่า และวันหมดอายุ">
</p>

**ปัญหา:** สเปรดชีตถูกเขียนทับ โรงงานกับสาขาตัวเลขไม่เคยตรงกัน และไม่มีใครบอกได้ว่าวันอังคารที่แล้วสต๊อกมีเท่าไร
...
**ลองเอง:** เปิด “สต๊อกคงเหลือ” แล้วตั้ง “ณ วันที่” เป็นสองวันก่อน

### เริ่มใช้ระบบโดยไม่ต้องวุ่นกับสเปรดชีต

<p align="center">
  <img src="docs/landing/img/th-opening-refused.webp" width="420" alt="ยอดยกมาใหม่ถูกปฏิเสธ เพราะ 2.5 ชิ้นมีทศนิยมเกินที่หน่วยเก็บได้">
  <img src="docs/landing/img/th-opening-reversed.webp" width="420" alt="ยอดยกมาที่ post แล้วถูกกลับรายการด้วย RV-2026-00001 พร้อมเก็บเหตุผลไว้">
</p>

**ปัญหา:** วันแรกของระบบใหม่คือวันที่ข้อมูลผิดเข้ามา: น่องไก่ครึ่งชิ้น lot ที่หมดอายุไปแล้ว ตัวเลขที่พิมพ์ซ้ำ
...
**ลองเอง:** เข้าสู่ระบบเป็น plant กด “สร้างยอดยกมา” แล้วใส่น่องไก่ 2.5 ชิ้น

### master data ชุดเดียว ทุกสาขา ทุกระบบ

<p align="center">
  <img src="docs/landing/img/th-items.webp" width="420" alt="สินค้าและหน่วยนับ: หน่วยหลัก หน่วยซื้อ เช่น 1 ถุง = 25 กิโลกรัม และอายุการเก็บ">
  <img src="docs/landing/img/th-supplier-tax-id.webp" width="420" alt="ซัพพลายเออร์ใหม่ถูกปฏิเสธ เพราะเลขประจำตัวผู้เสียภาษีไม่ผ่านหลักตรวจสอบ">
</p>

**ปัญหา:** แต่ละสาขาเรียกไก่ตัวเดียวกันคนละชื่อ ซัพพลายเออร์ขายเป็นถุง ครัวนับเป็นชิ้น และ POS ก็มีรายการของตัวเอง
...
**ลองเอง:** เข้าสู่ระบบเป็น purchasing กด “เพิ่มซัพพลายเออร์” แล้วพิมพ์เลขผู้เสียภาษีผิดหนึ่งหลัก

### คนที่ใช่ และเฉพาะคนที่ใช่

<p align="center">
  <img src="docs/landing/img/th-users.webp" width="420" alt="ผู้ใช้และบทบาท: ผู้ใช้เดโมเจ็ดคน บทบาท และสถานะการยืนยันตัวตนขั้นที่สอง">
  <img src="docs/landing/img/th-second-factor.webp" width="420" alt="ขั้นยืนยันตัวตนขั้นที่สองตอนเข้าสู่ระบบ พร้อมรหัสกู้คืนของเดโมที่เผยแพร่ไว้">
</p>

**ปัญหา:** ทุกคนใช้บัญชีเดียวกัน ใครจะแก้อะไรก็ได้ และเมื่อมีอะไรผิดพลาดก็ไม่มีบันทึกว่าใครทำ
...
- **การแยกหน้าที่** — ไม่มีใครอนุมัติเอกสารที่ตัวเองสร้าง มาพร้อมการอนุมัติครั้งแรก _(วางแผนไว้: [#8](https://github.com/SuruchBoss/PaynEat-ERP/issues/8))_

**ลองเอง:** เข้าสู่ระบบเป็น admin ด้วยรหัสกู้คืนที่หน้าเข้าสู่ระบบแสดงไว้ แล้วเปิด “ผู้ใช้และบทบาท”

### เมื่อมีอะไรพัง คุณจะรู้ว่าเพราะอะไร

<p align="center">
  <img src="docs/landing/img/th-status.webp" width="720" alt="สถานะระบบ: API และฐานข้อมูลปกติทั้งคู่">
</p>

**ปัญหา:** “ระบบช้า” แล้วไม่มีใครหาคำขอที่ล้มเหลวเจอสักรายการ
...
**ลองเอง:** เปิด “สถานะระบบ” ถ้าติดตั้งด้วย Docker ลองหยุดฐานข้อมูลแล้วกด “ตรวจอีกครั้ง”

### ที่โต๊ะทำงาน บนแท็บเล็ต ในกระเป๋า

<p align="center">
  <img src="docs/landing/img/th-phone-stock.webp" width="240" alt="สต๊อกคงเหลือบนมือถือ แต่ละ lot เป็นการ์ด ในโหมดสว่าง">
  <img src="docs/landing/img/th-phone-stock-dark.webp" width="240" alt="หน้าจอเดียวกันในโหมดมืด">
</p>

**ปัญหา:** ผู้จัดการสาขาอยู่หน้าร้าน ไม่ได้นั่งโต๊ะ และไม่ใช่ทุกคนอ่านภาษาอังกฤษ
...
| [0020](docs/adr/0020-distribution-and-installation.th.md) | console ติดตั้งจาก browser ลงมือถือ แท็บเล็ต และ PC ได้ (v1, ไม่ cache ข้อมูล); หลัง v1 เชนติดตั้งเซิร์ฟเวอร์เองได้โดยไม่ต้องมีนักพัฒนา (ตั้งค่าครั้งแรกผ่านหน้าจอ ตัวติดตั้งคำสั่งเดียว สำรองข้อมูลและอัปเกรดจาก console); PaynEat Cloud หลังเชนนำร่อง; ติดตั้งเองได้เสมอ |
| [0021](docs/adr/0021-public-demo-in-the-browser.th.md) | เดโมสาธารณะของ console บน GitHub Pages ที่ตอบคำขอในเบราว์เซอร์ด้วยกฎและข้อมูลเดโมชุดเดียวกับ backend ไม่ใช่สำเนา; หน้าจอที่เดโมไม่รองรับจะบอกตรงๆ; build ปกติไม่มีเดโมติดไปเลย |
...
6. คุณภาพ: เทสต์ ข้อมูล demo เอกสาร วิดีโอพาทัวร์ และ console ที่ติดตั้งจาก browser ลงมือถือ แท็บเล็ต และ PC ได้

หลัง release แรก ตามลำดับ: ส่งยอดคงเหลือสาขาให้ POS; ติดตั้งเซิร์ฟเวอร์ได้โดยไม่ต้องมีนักพัฒนา (ตั้งค่าครั้งแรกผ่าน
console, ตัวติดตั้งคำสั่งเดียว, สำรองข้อมูลและอัปเกรดจาก console, [ADR-0020](docs/adr/0020-distribution-and-installation.th.md));
แม่แบบนำเข้าข้อมูลของเชน; public API ที่มีเวอร์ชัน, API token แบบจำกัดสิทธิ์ และ webhook ขาออก เพื่อให้เชนสร้าง
ส่วนเสริมของตัวเองเป็นบริการแยกได้ ([ADR-0013](docs/adr/0013-extension-by-integration.th.md)); จากนั้นเชนนำร่อง
และ PaynEat Cloud สำหรับเชนที่ไม่มีทีมไอที
...
**ข้อมูลหลัก** ได้แก่ สินค้า หน่วยนับ และหน่วยซื้อ; สถานที่เก็บสต๊อกซึ่งใช้รหัสร่วมกับ POS และ Cwork; ซัพพลายเออร์
โดยทุกการเปลี่ยนแปลงของสินค้าหรือสาขาได้เวอร์ชัน master data ใหม่ให้ POS ดึงไปใช้ **stock ledger** ได้แก่
ยอดยกมาและสต๊อกคงเหลือแยกตามสินค้า lot และสถานที่ ณ วันใดก็ได้ และโครงระบบข้างใต้ ได้แก่ API ที่รายงานสถานะของตัวเองและของฐานข้อมูล เขียนทุก request เป็น JSON แบบมีโครงสร้าง
(ตาม[สัญญา telemetry](docs/TELEMETRY.md) ของระบบนิเวศ) และนับ request การเข้าสู่ระบบที่ถูกปฏิเสธ และการ post
เป็น metric ของ Prometheus

### ในเบราว์เซอร์ ไม่ต้องติดตั้งอะไร

เปิด **https://suruchboss.github.io/PaynEat-ERP/** นี่คือ console ตัวนี้ที่ build พร้อม demo API ในเบราว์เซอร์แทนเซิร์ฟเวอร์
([ADR-0021](docs/adr/0021-public-demo-in-the-browser.th.md)) มีเชนสมมติและบัญชีเดโมด้านล่าง และปฏิเสธสิ่งที่ API ปฏิเสธ
เพราะใช้กฎชุดเดียวกับ backend สิ่งที่คุณแก้อยู่ในเบราว์เซอร์เฉพาะการเข้าชมครั้งนั้น และโหลดหน้าใหม่ก็เริ่มใหม่ หน้าเข้าสู่ระบบ
แสดงบัญชีและรหัสของผู้ดูแลระบบไว้ให้ ทุกหน้าจอในทัวร์ด้านล่างมีครบ หน้าจอที่เพิ่มทีหลังจะบอกเองถ้ายังไม่มีในเดโม ถ้าต้องการ
ตัว API เอง log และ metric หรือข้อมูลของคุณเอง ให้ติดตั้ง:

### บนเครื่องของคุณ ด้วย Docker

ต้องมี [Docker](https://docs.docker.com/get-docker/) และ `openssl` สำหรับขั้นแรก
...
docker compose run --rm migrate npm run db:seed     # เชนสมมติ: ผู้ใช้ สินค้า สถานที่ ซัพพลายเออร์ และยอดยกมา
...
|---|---|---|---|
| `admin` | `admin@demo-chicken.example` | จัดการผู้ใช้ บทบาท สถานที่เก็บสต๊อก การตั้งค่า; เปิดงวดที่ปิดแล้วอีกครั้ง | เข้าสู่ระบบด้วยการยืนยันตัวตนขั้นที่สอง; หน้า **ผู้ใช้และบทบาท**: ดูรายชื่อ เพิ่มผู้ใช้ ให้และถอนบทบาท; หน้า **สินค้าและหน่วยนับ**: เพิ่ม แก้ไข ปิดใช้งาน; หน้า **สถานที่เก็บสต๊อก**: เพิ่ม แก้รหัส ปิดใช้งาน แทนที่; หน้า **ซัพพลายเออร์**; ดูสต๊อกคงเหลือและยอดยกมา; อ่านบันทึกการตรวจสอบ (ผ่าน API) |
| `purchasing` | `purchasing@demo-chicken.example` | สร้างและส่งใบสั่งซื้อ; จัดการซัพพลายเออร์ | เข้าสู่ระบบได้; หน้า **ซัพพลายเออร์**: เพิ่ม แก้ไข ปิดใช้งาน; ดูสินค้า สถานที่ และสต๊อกคงเหลือ; หน้าจอใบสั่งซื้อมากับ #10 |
| `purchasing_approver` | `approver@demo-chicken.example` | อนุมัติใบสั่งซื้อที่เกินเกณฑ์วงเงินที่ต้องอนุมัติ | เข้าสู่ระบบได้; ดูสินค้า สถานที่ ซัพพลายเออร์ และสต๊อกคงเหลือ; หน้าจอมากับ #10 |
| `plant` | `plant@demo-chicken.example` | รับสินค้า ดำเนินการใบสั่งผลิต จัดการสต๊อกของโรงงาน | เข้าสู่ระบบได้; หน้า **ยอดยกมา**: ร่าง post กลับรายการ; หน้า **สต๊อกคงเหลือ**; ดูสินค้า สถานที่ และซัพพลายเออร์; หน้าจอรับสินค้าและผลิตมากับ #11 และ #13 |
| `logistics` | `logistics@demo-chicken.example` | ส่งของตามใบโอน | เข้าสู่ระบบได้; ดูสินค้า สถานที่ ซัพพลายเออร์ และสต๊อกคงเหลือ; หน้าจอมากับ #14 |
| `branch_manager` | `branch.manager@demo-chicken.example` | ออกใบขอเบิก รับโอน ตรวจนับสต๊อกสาขา | เข้าสู่ระบบได้; ดูสินค้า สถานที่ ซัพพลายเออร์ และสต๊อกคงเหลือ; หน้าจอมากับ #14 และ #15 |
| `finance` | `finance@demo-chicken.example` | ดูต้นทุน ส่วนต่าง และมูลค่าสต๊อก; export ข้อมูลทางการเงิน | เข้าสู่ระบบได้; หน้า **สต๊อกคงเหลือ** พร้อมต้นทุนและมูลค่า; ดูสินค้า สถานที่ และซัพพลายเออร์; หน้าจอมากับงานต้นทุนและการปิดงวดในสัปดาห์ที่ 4–5 |
...
ทุกขั้นทำได้ทั้งบน[เดโมสาธารณะ](https://suruchboss.github.io/PaynEat-ERP/) และบนระบบที่ติดตั้งด้วย Docker บนเดโม โหลดหน้าใหม่แล้วทุกอย่างกลับเป็นเหมือนเดิม
...
8. เปิด **สถานที่เก็บสต๊อก**: มีโรงงานบางนา `PLANT-01` สถานที่ระหว่างขนส่งของมัน `IN-TRANSIT:PLANT-01` (ระบบสร้าง
   และแก้ไขไม่ได้) และสาขาสามแห่ง กด **เพิ่มสถานที่** เป็นคลัง `wh-01` (ระบบเก็บเป็น `WH-01`) จะได้
   `IN-TRANSIT:WH-01` ทันที ลองใส่รหัสที่มีเว้นวรรคหรือเป็นภาษาไทย: ถูกปฏิเสธพร้อมกฎ กด **แก้ไข** สาขาแล้วแก้รหัส:
   ทำได้เพราะยังไม่มีเอกสารใดใช้ และจะไปอยู่ใน `GET /api/v1/master-data/changes` เหมือนสินค้า เมื่อเอกสารที่ post แล้ว
   หรือการดึงข้อมูลของ POS ใช้รหัสครั้งแรก (ตั้งแต่ #8) รหัสจะเปลี่ยนไม่ได้อีก ถ้ารหัสผิดแต่ถูกใช้ไปแล้ว ให้สร้างสาขา
   ที่รหัสถูก แล้วใช้ **แทนที่ด้วยสถานที่อื่น** กับสาขาเดิม ซึ่งจะปิดใช้งานสาขาเดิมพร้อมลิงก์ที่ POS ได้รับด้วย ทุกคำขอ
   เกี่ยวกับสถานที่มี `"location_code"` ในบรรทัด log
9. เข้าสู่ระบบเป็น **purchasing**: เพิ่มและแก้ **ซัพพลายเออร์** ได้ (สิ่งเดียวที่บทบาทนี้แก้ได้ตอนนี้) เลขประจำตัวผู้เสียภาษี
   พิมพ์มีขีดหรือไม่มีก็ได้ และถ้าพิมพ์ผิดหลักระบบจะจับได้จากหลักตรวจสอบ ซัพพลายเออร์อยู่ใน ERP เท่านั้น ไม่ส่งไป POS
10. เปิด **สต๊อกคงเหลือ** (บัญชีไหนก็ได้): สต๊อกยกมาของโรงงาน — แป้งชุบทอด น้ำมันทอด และไก่ทั้งตัวสาม lot
   ที่ชั่งน้ำหนักพร้อมจำนวนตัว และหมดอายุคนละวัน — แต่ละ lot มีต้นทุนต่อหน่วยและมูลค่า รวม 22,716.7 บาท
   ทุกตัวเลขเป็นทศนิยมแบบแม่นยำจาก ledger ไม่ปัดเศษ ลองตั้ง **ณ วันที่** เป็นสองวันก่อน: ไม่มีอะไร เพราะยอดยกมา
   ลงวันที่เมื่อวาน สต๊อก ณ วันที่ใดนับตามวันที่เกิดรายการ ไม่ใช่วันที่ post (ADR-0018)
11. เข้าสู่ระบบเป็น **plant** เปิด **ยอดยกมา** แล้วกด **สร้างยอดยกมา** ที่สาขาหนึ่ง: บรรทัดไก่ทั้งตัว (กิโลกรัมและ
   จำนวนตัว) และบรรทัดน่องไก่ ลองใส่น่องไก่ `2.5` ชิ้น: ถูกปฏิเสธที่บรรทัดนั้น เพราะชิ้นไม่มีทศนิยม (ADR-0019)
   กด **บันทึกร่าง**: ได้เลขที่ทันที (`OB-2026-00002`) และยังไม่กระทบสต๊อก กด **Post เอกสารนี้**: ทุกบรรทัดกลายเป็น
   lot (`OB-2026-00002/1`, `/2`) ในธุรกรรมเดียว หรือไม่เกิดอะไรเลย เอกสารที่ post แล้วแก้ไม่ได้ ให้กด
   **กลับรายการเอกสารนี้** พร้อมเหตุผล ระบบ post `RV-2026-00001` ที่หักล้างเอกสารเดิมพอดี ทั้งสองฉบับยังเปิดดูได้
   lot ของเอกสารนั้นหายจากสต๊อกคงเหลือ และการกลับรายการเอกสารเดิมซ้ำถูกปฏิเสธ แม้สองคำขอจะมาพร้อมกันก็ตาม
   lot ที่หมดอายุก่อนวันที่เกิดรายการก็ถูกปฏิเสธเช่นกัน ทุกการ post และทุกการปฏิเสธเป็นบรรทัด log
   `ledger.posting.succeeded` หรือ `ledger.posting.refused` ที่มี `document_number` (และ `rule` ที่ปฏิเสธ) และนับใน
   `erp_postings_total`
12. ทุกการเปลี่ยนแปลงข้างบน และทุกการเข้าสู่ระบบที่ถูกปฏิเสธ อยู่ในบันทึกการตรวจสอบ พร้อมผู้กระทำ เวลา และรหัส
...
รายการเคลื่อนไหวใน ledger แก้หรือลบไม่ได้ ฐานข้อมูลเองปฏิเสธ สต๊อกคงเหลือของวันนี้อ่านจากตารางยอดคงเหลือที่ทุกการ
post อัปเดตไว้ ถ้าไม่ตรงกัน ledger ถูกเสมอ และ `docker compose run --rm migrate npm run ledger:rebuild-balances`
สร้างตารางยอดคงเหลือใหม่จาก ledger โดยแสดงยอดที่เคยไม่ตรงก่อน
